...
| `timeline.triassic` | `timeline` | `doc/resource/01-timeline/triassic.md` | `draft` | 三叠纪纪级骨架页 |
| `timeline.jurassic` | `timeline` | `doc/resource/01-timeline/jurassic.md` | `draft` | 侏罗纪纪级骨架页 |
| `timeline.cretaceous` | `timeline` | `doc/resource/01-timeline/cretaceous.md` | `draft` | 白垩纪纪级骨架页 |
| `timeline.cenozoic-overview` | `timeline` | `doc/resource/01-timeline/cenozoic-overview.md` | `active` | 新生代总览页 |
| `timeline.paleogene` | `timeline` | `doc/resource/01-timeline/paleogene.md` | `draft` | 古近纪纪级骨架页 |
| `timeline.neogene` | `timeline` | `doc/resource/01-timeline/neogene.md` | `draft` | 新近纪纪级骨架页 |
| `timeline.quaternary` | `timeline` | `doc/resource/01-timeline/quaternary.md` | `draft` | 第四纪纪级骨架页 |
